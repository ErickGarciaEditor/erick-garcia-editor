...
const translations: Record<Exclude<Lang, 'pt'>, Record<string, string>> = {
  en: {
    ...
    'A partir de R$700 por mês': 'From US$220 per month',
    'Social Media Essencial': 'Essential Social Media',
    'A partir de R$1.200 por mês': 'From US$390 per month',
    'Social Media Completo': 'Complete Social Media',
    'A partir de R$1.800 por mês': 'From US$590 per month',
    'Landing Page Profissional': 'Professional Landing Page',
    'A partir de R$1.500 por projeto': 'From US$490 per project',
    'Site Institucional': 'Institutional Website',
    'A partir de R$2.500 por projeto': 'From US$790 per project',
    'Captação Presencial': 'On-site Recording',
    'A partir de R$400 por diária curta': 'From US$150 per short session',
  ...
  es: {
    ...
    'A partir de R$700 por mês': 'Desde €200 al mes',
    'Social Media Essencial': 'Social Media Esencial',
    'A partir de R$1.200 por mês': 'Desde €540 al mes',
    'Social Media Completo': 'Social Media Completo',
    'A partir de R$1.800 por mês': 'Desde €540 al mes',
    'Landing Page Profissional': 'Landing Page Profesional',
    'A partir de R$1.500 por projeto': 'Desde €450 por proyecto',
    'Site Institucional': 'Sitio Institucional',
    'A partir de R$2.500 por projeto': 'Desde €720 por proyecto',
    'Captação Presencial': 'Grabación Presencial',
    'A partir de R$400 por diária curta': 'Desde €140 por jornada corta',
