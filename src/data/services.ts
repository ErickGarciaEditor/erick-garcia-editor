...
export const services: ServiceItem[] = [
  {
    title: 'Social Media',
    description:
      'Gestão, edição e publicação para marcas que precisam aparecer com mais qualidade, consistência e organização nas redes sociais.',
    items: [
      ...
      'Legendas',
      'Tratamento de cor',
      'Publicação e programação',
      'Instagram, TikTok e YouTube',
      'Acompanhamento',
      'Relatório mensal',
      'Orientação para gravação remota',
      'Captação presencial mediante orçamento',
    ],
  },
  {
    title: 'Sites Profissionais',
    description:
      'Landing pages e sites institucionais projetados para apresentar serviços com clareza e transformar visitas em contatos.',
    items: [
      'Landing pages',
      ...
      'Manutenção mediante contratação',
    ],
  },
];
...
export const pricing = [
  ...
  },
  {
    ...
    description:
      'Indicado para quem deseja organizar as redes sociais e também ter uma estrutura profissional fora das plataformas.',
  },
  {
